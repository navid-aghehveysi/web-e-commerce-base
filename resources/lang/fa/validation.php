...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'password' => [
            ...
            'symbols' => 'رمز عبور باید حداقل شامل یک نویسه خاص باشد.',
            'min' => 'رمز عبور باید حداقل :min کاراکتر داشته باشد.',
            'confirmed' => 'رمز عبور و تکرار آن یکسان نیستند.',
            'uncompromised' => 'رمز عبور وارد شده در یک نشت اطلاعاتی مشاهده شده است. لطفاً رمز عبور دیگری انتخاب کنید.',
        ],
    ...
    */
    'attributes' => [
        ...
        "delivery_time_unit"        => "واحد اندازه گیری زمان ارسال",
        "weight"                    => "وزن",
        "height"                    => "ارتفاع",
        "length"                    => "طول",
        "width"                     => "عرض",
        ...
        "frozen_number"             => "تعداد باقی مانده",
        "percentage"                => "درصد تخفیف",
        "discount_ceiling"          => "حداکثردرصد تخفیف",
        ...
        "received_by"               => "تحویل گیرنده",
        "delivered_by"              => "تحویل دهنده",
        "product_id"                => "محصول",
        "primary_phone_number"      => "شماره همراه",
        "primary_image"             => "تصویر",
        "subtitle"                  => "زیر عنوان",
        ...
        'work_hours_from'           => "شروع ساعت",
        'work_hours_to'             => "پایان ساعت",
        'first_name_fa'             => "نام",
        'last_name_fa'              => "نام خانوادگی",
        'company'                   => "شرکت / موسسه",
        'persian_name'              => "نام پارسی",
        'platform'                  => "بستر ارتباطی",
        'name_en'                   => "نام لاتین",
        'name_fa'                   => "نام پارسی",
    ],
];
