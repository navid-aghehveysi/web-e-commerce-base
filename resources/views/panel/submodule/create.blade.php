...
@section('main-header')
    <section class="main-header ">
        ...
        <section class="flex items-center justify-between">
            ...
            <h2 class="text-2xl">ساخت ساب ماژول</h2>
...
{{--    @if( auth()->user()->can('create' , \App\Models\Module::class))--}}
        ...
        <div class="simple-form">
            ...
            <form action="{{ route('panel.submodule.store') }}" method="post"  id="form" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="w-full col-span-6 lg:col-span-2">
                        ...
                        <select id="module_id" name="module_id" class="">
                            @foreach($modules as $module)
                                <option value="{{$module->id}}" {{ old('module_id') }}
                                >{{
                                $module->name_fa
                                }}</option>
                            @endforeach
