...
@endpush
@section('title' , 'ساب ماژول  - ویرایش')
...
@section('main-header')
    <section class="main-header ">
        ...
        <section class="flex items-center justify-between">
            ...
            <h2 class="text-2xl">ویرایش ساب ماژول</h2>
            <div class="flex items-center justify-between">
                <a href="{{ route('panel.submodule.index') }}" class="btn bg-red-50 text-red-700 ring-red-600/20">
                    <span></span>
...
{{--    @if( auth()->user()->can('create' , \App\Models\Module::class))--}}
        ...
        <div class="simple-form">
            ...
            <form action="{{ route('panel.submodule.update', $submodule->id) }}" method="post"  id="form"
                ...
                <section class="grid grid-cols-6 gap-y-8 gap-x-4 mb-4">
                    <div class="w-full col-span-6 lg:col-span-2">
                        ...
                        <input type="text" name="name_en" id="name_en"  value="{{ old('name_en', $submodule->name_en)
                        }}">
                        @error('name_en')
                    ...
                    <div class="w-full col-span-6 lg:col-span-2">
                        ...
                        <input type="text" name="name_fa" id="name_fa"  value="{{ old('name_fa', $submodule->name_fa)
                        }}">
                        @error('name_fa')
                        <span class="text-rose-600" role="alert">
                            {{$message}}
                    ...
                    <div class="w-full col-span-6 lg:col-span-2">
                        ...
                        <input type="text" name="route" id="route" dir="ltr"  value="{{ old('route', $submodule->route)
                        }}">
                        @error('route')
                        <span class="text-rose-600" role="alert">
                            {{$message}}
                    ...
                    <div class="w-full col-span-6 lg:col-span-2">
                        <label for="module_id" class="">ماژول والد</label>
                        <select id="module_id" name="module_id" class="">
                    ...
                    <div class="w-full col-span-6 lg:col-span-2">
                        ...
                        <select id="status" name="status" class="">
                            @foreach($statuses as $value => $label)
                                <option value="{{$value}}"
                                        {{ old('status', $submodule->status) == $value ? 'selected' : ''}} >
                                    {{$label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="w-full col-span-6 lg:col-span-2">
                        ...
                        <input type="text" name="order" id="order" value="{{ old('order', $submodule->order) }}">
                        @error('order')
                        <span class="text-rose-600" role="alert">
                            {{$message}}
                        </span>
                    ...
                    <div class="w-full col-span-6">
                        ...
                        <textarea id="description" name="description">{{ old('description', $submodule->description)
                        }}</textarea>
                        @error('description')
                        <span class="text-rose-600" role="alert">
                            {{ $message }}
